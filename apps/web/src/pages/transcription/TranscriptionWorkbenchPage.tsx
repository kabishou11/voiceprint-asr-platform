          ...
          <CardContent>
            <Stack spacing={2.25}>
              <Stack direction="row" spacing={1} flexWrap="wrap" useFlexGap>
                <Chip
                  size="small"
                  label={gpuReady ? 'GPU 已就绪' : 'CUDA 未就绪'}
                  color={gpuReady ? 'success' : 'default'}
                />
                <Chip size="small" label={runtimeLabel('ASR', asrState)} color={runtimeColor(asrState)} />
                <Chip
                  size="small"
                  label={runtimeLabel('分离', diarizationState)}
                  color={runtimeColor(diarizationState)}
                />
                <Chip
                  size="small"
                  label={runtimeLabel('声纹', voiceprintState)}
                  color={runtimeColor(voiceprintState)}
                />
                <Chip
                  size="small"
                  label={pyannoteState === 'ready' ? 'pyannote 已就绪' : 'pyannote 未启用'}
                  color={pyannoteState === 'ready' ? 'success' : 'default'}
                />
              </Stack>
